    ...
    while True:
        ...
        if choice == "1":
            ...
            while True:
                ...
                number_of_articles = input("How many articles would you want: ")
                # if invalid number of articles ask to enter valid
                while not number_of_articles.isdigit() or int(number_of_articles) <= 0:
                    number_of_articles = input("Invalid choice. Please enter the number of articles: ")
                ...
                for story in stories:
                    entries.append(create_newsletter.create_newsletter_entry(stories["title"], stories["url"]))
